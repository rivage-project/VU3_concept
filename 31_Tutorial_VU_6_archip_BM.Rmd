...
To show these in an aggregated manner, we can plot each island as a ro, rank the islands bu VU value, and still plot the species variability with lighter grey dots.
